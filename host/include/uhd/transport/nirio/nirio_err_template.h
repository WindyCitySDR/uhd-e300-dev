...
NIRIO_ERR_INFO(NiRio_Status_RpcConnectionError, -63040, "A connection could not be established to the specified remote device. Ensure that the device is on and accessible over the network, that NI-RIO software is installed, and that the RIO server is running and properly configured.")
NIRIO_ERR_INFO(NiRio_Status_RpcSessionError, -63040, "The RPC session is invalid. Ensure that the device is connected and try restarting the server.")
