...
static const char* SIGNATURE = "EFE05FC18F34D1F1CD3582EDC73082E6C4816FA7DC9EC80C5DE93C5EB7047626";
...
static void initialize_fifo_info(nirio_interface::nirio_fifo_info_vtr& vtr)
{
    ...
    vtr.push_back(nirio_fifo_info_t(4, OUTPUT_FIFOS[0], OUTPUT_FIFO, 0xfe80, 261, SCALAR_U64, 64, 2)); //"TX FIFO 0"
    vtr.push_back(nirio_fifo_info_t(5, OUTPUT_FIFOS[1], OUTPUT_FIFO, 0xfe40, 261, SCALAR_U64, 64, 2)); //"TX FIFO 1"
    vtr.push_back(nirio_fifo_info_t(6, OUTPUT_FIFOS[2], OUTPUT_FIFO, 0xfe00, 261, SCALAR_U64, 64, 2)); //"TX FIFO 2"
    vtr.push_back(nirio_fifo_info_t(7, OUTPUT_FIFOS[3], OUTPUT_FIFO, 0xfdc0, 261, SCALAR_U64, 64, 2)); //"TX FIFO 3"
}
