...
// Note this is *ALL* the coeffs for a symetric halfband, not just
// one side of the filter.
// Uncomment zero's to pad to 128taps from 64  taps.

static uint16_t hb47_coeffs[] = {
  ...
  0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,
  0xfff1,0x0000,0x0030,0x0000,0xff92,0x0000,0x00d5,0x0000,
  0xfe88,0x0000,0x026b,0x0000,0xfc31,0x0000,0x059d,0x0000,
  0xf708,0x0000,0x0e4a,0x0000,0xe616,0x0000,0x5110,0x7fff,

  0x5110,0x0000,0xe616,0x0000,0x0e4a,0x0000,0xf708,0x0000,
  0x059d,0x0000,0xfc31,0x0000,0x026b,0x0000,0xfe88,0x0000,
  0x00d5,0x0000,0xff92,0x0000,0x0030,0x0000,0xfff1,0x0000,
  0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000
