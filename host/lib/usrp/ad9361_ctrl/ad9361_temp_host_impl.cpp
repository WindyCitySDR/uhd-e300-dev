...
class ad9361_ctrl_iface_impl : public ad9361_ctrl_iface_type {
public:
    ...
    double set_gain(const std::string &which, const double value) {
        ...
        if(which[0] == 'R') {
            ...
            double atten = ad9361_ctrl::get_gain_range("TX1").stop() - value;
            ...
            return ad9361_ctrl::get_gain_range("TX1").stop() - (double(attenreg)/ 4);
        }
    }
