...
#ifndef INCLUDED_LIBUHD_LB_TEST_HPP
#define INCLUDED_LIBUHD_LB_TEST_HPP
...
class loopback_test : boost::noncopyable {
public:
    const device_addr_t& run_test(
...
#endif /* INCLUDED_LIBUHD_LB_TEST_HPP */
